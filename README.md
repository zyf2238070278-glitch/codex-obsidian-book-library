...
当前测试版只面向 Apple Silicon Mac。它支持 PDF、EPUB、Markdown 和 TXT；扫描版 PDF 暂不提供 OCR。
...
5. 新建任务并说“检查书库状态”。状态正常后，在 Codex 附加 PDF、EPUB、Markdown 或 TXT，再说“导入这本书”。对话和文件附加都在 Codex 完成；Obsidian 只用来浏览书库与笔记。
